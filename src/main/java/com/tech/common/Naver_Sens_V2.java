...
public class Naver_Sens_V2 {
	...
	public void send_msg(String tel, String rand) {
        ...
        String accessKey = "mD2N7UjGiAQnLUlJLouP";                     						// 개인 인증키
        String secretKey = "a183bb80306f45c3b5fd9881f5da1f39";  										// 2차 인증을 위해 서비스마다 할당되는 service secret
        String serviceId = "ncp:sms:kr:286891283012:tech_house_project";        									// 프로젝트에 할당된 SMS 서비스 ID
	    ...
	    bodyJson.put("from","0108549076");	// 발신번호 * 사전에 인증/등록된 번호만 사용할 수 있습니다.		
