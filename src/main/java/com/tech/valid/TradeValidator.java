...
public class TradeValidator implements Validator {
	...
	public boolean supports(Class<?> clazz) {
		...
		return TradeVO.class.isAssignableFrom(clazz);
	}
	...
	public void validate(Object target, Errors errors) {
		...
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "t_text", "emptyT_text");	//오류 시 에러를등록,필드명,오류이름
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "t_title", "emptyT_title");
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "t_prodName", "emptyT_prodName");
	}
