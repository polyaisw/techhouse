...
<body>
<!-- 페이지정보 -->
	<c:url var="getPageRange" value="/board/news/hotDeal">
		<c:param name="page" value="${pagination.page}" />
		<c:param name="range" value="${pagination.range}" />
		
	</c:url>
	<c:url var="getPageUrl" value="board/news/hotDeal">
	</c:url>
	<c:set var="category" value="꿀딜/장터" />
