...
<body>
	<!-- 페이지정보 -->
	<c:url var="getPageRange" value="/board/community/mysetting">
		<c:param name="page" value="${pagination.page}" />
		<c:param name="range" value="${pagination.range}" />

	</c:url>
	<c:url var="getPageUrl" value="board/community/mysetting">
	</c:url>
	<c:set var="category" value="인증게시판" />
