...
<body>
<!-- 페이지정보 -->
	<c:url var="getPageRange" value="/board/trade/aftertrade">
		<c:param name="page" value="${pagination.page}" />
		<c:param name="range" value="${pagination.range}" />
		
	</c:url>
	<c:url var="getPageUrl" value="board/trade/aftertrade">
	</c:url>
	<c:set var="category" value="거래후기" />
				...
				<div class="col-md-9">
					...
					<div class="menu-list mt-5">
						<ul class="d-flex flex-row justify-content-around">
							<li><a href="/board/trade/tradeBoard" class="button-3">거래 게시판</a></li>
							<li><a href="/board/trade/aftertrade" class="button-3">거래후기</a></li>
							<li><a href="/board/trade/tradeInfo" class="button-3">중고거래 안내</a></li>
						</ul>
					</div>
				</div>
