							...
							<tbody>
								<c:forEach var="vo" items="${ CommentList }">
									<tr class="admin_board_content">
										...
										<td class="td_in">
											<a href="/board/contentForm?b_seq=${vo.c_boardSeq}" class="writer_List_admin" data-user-id="${vo.c_writer}">${vo.c_writer}</a>
										</td>
										<td class="td_in">
											<a href="/board/contentForm?b_seq=${vo.c_boardSeq}" class="text_List_admin d-inline-block text-truncate" style="max-width: 200px;" data-user-id="${vo.c_writer}">${vo.c_text}</a>
										</td>
										<td class="td_in">
