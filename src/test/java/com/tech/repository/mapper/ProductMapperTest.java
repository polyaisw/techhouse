...
public class ProductMapperTest {
	...
	@Test
	public void 응모글등록하기() throws Exception {
		ProductVO vo = new ProductVO("작성_RTX4090", "작성_3500000", "작성_image");
	...
	@Test
	public void 응모글삭제하기() throws Exception {
	...
	@Test
	public void 응모글수정하기() throws Exception {
		ProductVO vo = new ProductVO("수정_RTX4090", "수정_3500000", "수정_image");
		vo.setProd_seq(1);
	...
	@Test
	public void 아이디로응모글가져오기() throws Exception {
	...
	@Test
	public void 당첨자등록하기() throws Exception {

		ProductVO vo2 = pMapper.getProductById(1);
		ApplyVO vo = new ApplyVO(vo2.getProd_productName(), "당첨자이메일", "당첨자닉네임", "당첨자연락처");
	...
	@Test
	public void 추첨완료된상품수정불가() throws Exception {
