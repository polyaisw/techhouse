...
public class BoardMapperTest {
	...
	public void 게시판작성() throws Exception {
		// given
		BoardVO vo = new BoardVO("작성_title", "작성_writer", "작성_text", "작성_uploadImg", "작성_category");

		// when
		int row = bMapper.insertBoard(vo);
	...
	public void 게시판삭제() throws Exception {
		...
		// then
		assertNull(bMapper.getBoardById(vo.getB_seq())); // 지웠으니 null이어야한다.
	}
	...
	public void 게시판가져오기() throws Exception {
		...
		// when
		List<BVO> lists = bMapper.getBoardList();
		// then
	...
	public void 게시판가져오기아이디() throws Exception {
		BoardVO vo = (BoardVO) bMapper.getBoardById(100003);
	...
	public void 게시판가져오기카테고리() throws Exception {
		BoardVO vo = new BoardVO();
		vo.setB_category("작성_category");
		List<BVO> lists = bMapper.getBoardListByCate(vo.getB_category());
	}
