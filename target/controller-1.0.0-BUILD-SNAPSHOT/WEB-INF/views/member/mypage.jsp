			...
			<div class="col-md-4 ">
				...
				<div class="list-group" id="list-tab" role="tablist">
					<a class="list-group-item list-group-item-action active"
						...
						role="tab" aria-controls="list-home">개인정보</a> <a
						class="list-group-item list-group-item-action"
						id="list-profile-list" data-bs-toggle="list" href="#list-board"
						role="tab" aria-controls="list-profile">게시글 보기</a> <a
						class="list-group-item list-group-item-action"
						id="list-messages-list" data-bs-toggle="list" href="#list-trade"
						role="tab" aria-controls="list-messages">거래 내역</a> <a
						class="list-group-item list-group-item-action"
						id="list-settings-list" data-bs-toggle="list"
						href="#list-commission" role="tab" aria-controls="list-settings">고객
						상담 내역</a> <a class="list-group-item list-group-item-action"
